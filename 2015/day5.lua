...
oiuroieurpyejuvm]]
words = {}
for word in string.gmatch(input, "%l+") do
...
function checkvogals(str)
    ...
    local astr = table.concat(vogs)
    return #vogs >= 3
end
function checkdoubles(str)
    for i = 1, #str - 1 do
        local astr = string.sub(str, i, i + 1)
        local s1, s2 = string.sub(astr, 1, 1), string.sub(astr, 2, 2)
...
function valid1(str)
    local rule1 = checkvogals(str)
    local rule2 = checkdoubles(str)
    local rule3 = checkpoibiden(str)
